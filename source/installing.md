...
Binary distributions are available in [gzipped tar format](https://github.com/spotbugs/spotbugs/archive/3.1.0_preview2.tar.gz) and [zip format](https://github.com/spotbugs/spotbugs/archive/3.1.0_preview2.zip).
